       ...
       <b-row class="my-5">  
         <b-col cols="12" sm="7">
           <b-col cols="12" sm="9">
              ...
              <h2>Mail</h2>
              <p>
                I have two different email. The first one is more private but I will answer quicker. the second is more formal.
              </p>
           </b-col>
         ...
         <b-col cols="12" sm="5" class="text-center my-4" >
            <svg xmlns="http://www.w3.org/2000/svg" width="122" height="91.5" viewBox="0 0 122 91.5">
              <path d="M122,12.125v76.25A7.489,7.489,0,0,1,114.375,96H106.75V26.8L61,59.654,15.25,26.8V96H7.625A7.486,7.486,0,0,1,0,88.375V12.125A7.493,7.493,0,0,1,7.625,4.5h2.542L61,41.354,111.833,4.5h2.542A7.493,7.493,0,0,1,122,12.125Z" transform="translate(0 -4.5)" fill="#32302f"/>
            </svg>

            <div class="my-3">
              <a href="mailto:gaulph@gmail.com">(1) gaulph@gmail.com</a>
              <br>
              <a href="mailto:contact-pro@cecile-gaultier.fr"> (2) contact-pro@cecile-gaultier.fr</a>
            </div>
       ...
       <b-row class="my-5">  
         <b-col cols="12" sm="7">
           <b-col cols="12" sm="9">
              ...
              <h2>Phone</h2>
              <p>
                You can contact me on my private phone. I strongly recommend you to leave a message on my voicemail or to send me a message. 
              </p>
           </b-col>         
         </b-col>
         ...
         <b-col cols="12" sm="5" class="text-center my-4" >
           <svg xmlns="http://www.w3.org/2000/svg" width="122" height="122" viewBox="0 0 122 122">
            <path d="M3.48,86.21,30.168,74.772a5.719,5.719,0,0,1,6.672,1.644l11.819,14.44A88.322,88.322,0,0,0,90.88,48.635L76.44,36.816A5.7,5.7,0,0,1,74.8,30.144L86.233,3.456A5.757,5.757,0,0,1,92.786.144l24.781,5.719A5.719,5.719,0,0,1,122,11.437,110.551,110.551,0,0,1,11.436,122a5.719,5.719,0,0,1-5.576-4.432L.141,92.786A5.788,5.788,0,0,1,3.48,86.21Z" transform="translate(0 0)" fill="#32302f"/>
           </svg>
       ...
       <b-row class="my-5">  
         <b-col cols="12" sm="7">
           <b-col cols="12" sm="9">
              ...
              <div class="text-center"> 
                <div class="download my-3">
                    <a href="#">RGPD - Attestation</a>
                </div>
              </div>

              <div class="text-center"> 
                <div class="download my-3">
                    <a href="#">Cambridge - Certification</a>
                </div>
              </div>
