        ...
        <div class="carousel" data-ride="carousel" id="monCarousel" data-interval="1500">
            ...
            <div class="carousel-inner">  
                <div class="carousel-item active">
                    <img src="../../assets/mmi-carrousel-1.jpg" class="d-block w-100">         
                </div>
                <div class="carousel-item ">
                    <img src="../../assets/mmi-carrousel-2.jpg" class="d-block w-100">
                </div>
                <div class="carousel-item ">
                    <img src="../../assets/mmi-carrousel-3.jpg" class="d-block w-100">
                </div>
               <div class="carousel-item ">
                    <img src="../../assets/mmi-carrousel-4.jpg" class="d-block w-100">
                </div>
            </div>
